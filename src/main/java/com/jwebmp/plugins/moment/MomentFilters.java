...
public enum MomentFilters
{
	...
	amLocal,
	/**
	 * Applies a timezone to the given date / moment object. You need to include moment-timezone.js in your project and load timezone data in order to use this filter. The
